...
- `stream_revision` - Integer(optional, read only). A revision of an event inside its stream. Max value is capped to 2^31(2_147_483_648). If you bloat a single stream to this point - you should probably re-consider the logic behind it.
