...
RSpec.describe PgEventstore::CLI::Parsers::SubscriptionParser do
  subject { instance }
  ...
  describe '.banners' do
    ...
    it { is_expected.to match(a_string_including("Usage: pg-eventstore subscriptions [command] [options]")) }
  end
end
