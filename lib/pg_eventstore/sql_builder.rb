...
module PgEventstore
  ...
  class SQLBuilder
    ...
    UNION_MODES = %i[all distinct].freeze
    ...
    def from(table_name)
      ...
      @table_alias = table_name.is_a?(SQLBuilder) ? table_name.table_alias : table_name
      self
    end
    ...
    def union_query_sql
      ...
      union_mode_sql = @union_mode == :all ? 'UNION ALL' : 'UNION'
